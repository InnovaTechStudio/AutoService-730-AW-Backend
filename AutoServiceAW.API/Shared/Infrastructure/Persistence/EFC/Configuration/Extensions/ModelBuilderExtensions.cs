...
/// <summary>
/// Provides extension methods for the Entity Framework Core <see cref="ModelBuilder"/> to enforce structural database schemas.
/// </summary>
public static class ModelBuilderExtensions
{
    ...
    /// <summary>
    /// Iterates through the mapped Entity Framework data structure model, transforming names to an explicit snake_case database naming convention.
    /// </summary>
    /// <param name="builder">The target model builder configuration engine reference.</param>
